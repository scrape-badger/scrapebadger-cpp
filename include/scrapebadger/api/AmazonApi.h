...
public:
    ...
    /// <param name="asin"></param>
    /// <param name="domain"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="page">Review page (10 reviews/page) (optional, default to 0)</param>
    /// <param name="sortBy">helpful | recent (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="star">1-5 | one_star..five_star | positive | critical | all_stars (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
